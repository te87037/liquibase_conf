--
-- Table structure for table `lock_24xsc_baijiale`
--

DROP TABLE IF EXISTS `lock_24xsc_baijiale`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lock_24xsc_baijiale` (
  ...
  `specialvalue` varchar(100) NOT NULL DEFAULT ' ' COMMENT '特征值:无。',
...
--
-- Table structure for table `lock_24xsc_budingwei`
--

DROP TABLE IF EXISTS `lock_24xsc_budingwei`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lock_24xsc_budingwei` (
  `issue` varchar(20) NOT NULL COMMENT '奖期',
  `threadid` tinyint(2) unsigned NOT NULL DEFAULT '0' COMMENT '线程id',
  `methodid` int(8) NOT NULL DEFAULT '0' COMMENT '玩法ID',
  `code` varchar(100) NOT NULL COMMENT '号码',
  `specialvalue` varchar(100) NOT NULL DEFAULT ' ' COMMENT '特征值',
  `stamp` varchar(50) NOT NULL DEFAULT ' ' COMMENT '组三组六特征(数字型：1组三，2组六，乐透型：号码排序值)',
  `prizes` decimal(14,4) NOT NULL DEFAULT '0.0000' COMMENT '奖金值',
  `isbonuscode` tinyint(2) NOT NULL DEFAULT '0' COMMENT '是否对应当期开奖号码(0:否,1:是)',
  UNIQUE KEY `idx_index` (`issue`,`methodid`,`code`),
...
--
-- Table structure for table `lock_24xsc_dingbaiwei`
--

DROP TABLE IF EXISTS `lock_24xsc_dingbaiwei`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lock_24xsc_dingbaiwei` (
  `issue` varchar(20) NOT NULL COMMENT '奖期',
  `threadid` tinyint(2) unsigned NOT NULL DEFAULT '0' COMMENT '线程id',
  `methodid` int(8) NOT NULL DEFAULT '0' COMMENT '玩法ID',
  `code` varchar(100) NOT NULL COMMENT '号码',
...
--
-- Table structure for table `lock_24xsc_dinggewei`
--

DROP TABLE IF EXISTS `lock_24xsc_dinggewei`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lock_24xsc_dinggewei` (
  `issue` varchar(20) NOT NULL COMMENT '奖期',
  `threadid` tinyint(2) unsigned NOT NULL DEFAULT '0' COMMENT '线程id',
  `methodid` int(8) NOT NULL DEFAULT '0' COMMENT '玩法ID',
  `code` varchar(100) NOT NULL COMMENT '号码',
